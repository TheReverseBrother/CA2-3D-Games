...
namespace GDLibrary
{
    ...
    {
        #region Fields
        private float elevationAngle, originalElevationAngle, distance, scrollSpeedDistanceMultiplier, scrollSpeedElevationMultiplier;
        ...
        public float OriginalElevationAngle
        {
            get
            {
                return originalElevationAngle;
            }
            set
            {

                originalElevationAngle = value;
            }
        }
        ...
        public ThirdPersonController(string id, ControllerType controllerType, Actor targetActor,
            float distance, float scrollSpeedDistanceMultiplier, float elevationAngle, float angle,
        ...
        private void UpdateParent(GameTime gameTime, Actor3D parentActor, Actor3D targetActor)
        {
            if (targetActor != null)
            {
                ...
                //Sets the Angle to be 45 degrees so we get an isometric view
                cameraToTarget += new Vector3(0, 0, this.angle);
        ...
        public override object Clone()
        {
            return new ThirdPersonController("clone - " + this.ID, //deep
                ...
                this.inputManagerParameters); //shallow - a ref
